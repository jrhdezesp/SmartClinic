    ...
    <div class="contacto-layout">
      ...
      <div class="contacto-form reveal reveal-delay-1">
        ...
        <form id="contactoForm" novalidate>
          ...
          <div class="form-alert success" id="alertSuccess">✅ ¡Mensaje enviado correctamente! Te contactaremos pronto.</div>
          <div class="form-alert error" id="alertError">⚠️ Por favor completa todos los campos requeridos.</div>
        </form>
      </div>
    </div>
  </div>
