<div class="container section-pad">
    ...
    <div style="max-width:700px; margin:0 auto;">
        ...
        <div style="background:#fff; border-radius:16px; padding:2rem; box-shadow:0 4px 20px rgba(0,0,0,.08);">
            <form method="POST" action="index.php?page=CitasController&action=edit&id={{cita_id}}" novalidate>

                <div style="margin-bottom:1.5rem;">
                    <label style="display:block; font-weight:700; color:#0f172a; margin-bottom:0.5rem;">Paciente</label>
                    <select name="paciente_id" required style="width:100%; padding:0.95rem; border:1px solid #e2e8f0; border-radius:12px; font-size:1rem;">
                        {{foreach pacientes}}
                ...
                <div style="margin-bottom:1.5rem;">
                    ...
                    <select name="medico_id" required style="width:100%; padding:0.95rem; border:1px solid #e2e8f0; border-radius:12px; font-size:1rem;">
                        {{foreach medicos}}
                ...
                <div style="margin-bottom:1.5rem;">
                    ...
                    <input type="date" name="fecha" value="{{fecha}}" min="{{minDate}}" max="{{maxDate}}" required style="width:100%; padding:0.95rem; border:1px solid #e2e8f0; border-radius:12px; font-size:1rem;">
                </div>

                <div style="margin-bottom:1.5rem;">
                    <label style="display:block; font-weight:700; color:#0f172a; margin-bottom:0.5rem;">Hora</label>
                    <select name="hora" required style="width:100%; padding:0.95rem; border:1px solid #e2e8f0; border-radius:12px; font-size:1rem;">
                ...
                <div style="margin-bottom:1.5rem;">
                    ...
                    <select name="estado_id" required style="width:100%; padding:0.95rem; border:1px solid #e2e8f0; border-radius:12px; font-size:1rem;">
                        {{foreach estados}}
