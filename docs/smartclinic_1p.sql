...
ALTER TABLE roles_usuarios
  ADD CONSTRAINT fk_roles_usuarios_usuario
  FOREIGN KEY (usuarioId) REFERENCES usuario(usercod)
...
(1, 'Administrador', 'Acceso total al sistema', 'ACT'),
(2, 'Recepción', 'Gestión de pacientes y citas', 'ACT');

INSERT INTO funciones (funcionId, funcionNombre, funcionDescripcion, funcionStatus) VALUES
(1, 'Ver panel', 'Acceso al panel principal', 'ACT'),
(2, 'Gestionar usuarios', 'Administrar cuentas de acceso', 'ACT'),
(3, 'Gestionar roles', 'Administrar roles del sistema', 'ACT'),
(4, 'Gestionar funciones', 'Administrar permisos y accesos', 'ACT'),
(5, 'Gestionar pacientes', 'Registrar y actualizar pacientes', 'ACT'),
(6, 'Gestionar médicos', 'Registrar y actualizar médicos', 'ACT'),
(7, 'Gestionar citas', 'Registrar y actualizar citas', 'ACT');

INSERT INTO usuario (usercod, username, useremail, userpswd, userfching, userpswdest, userpswdexp, userest, useractcod, userpswdchg, usertipo) VALUES
(1, 'Administrador', 'admin@smartclinic.com', 'SmartClinic#2026', CURRENT_TIMESTAMP, 'ACT', NULL, 'ACT', 'ADMIN', NULL, 'ADM');

INSERT INTO roles_usuarios (rolUsuarioId, usuarioId, rolId, ruStatus, ruFechaInicio, ruFechaFin) VALUES
(1, 1, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59');

INSERT INTO funciones_roles (funcionRolId, funcionId, rolId, frStatus, frFechaInicio, frFechaFin) VALUES
(1, 1, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(2, 2, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(3, 3, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(4, 4, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(5, 5, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(6, 6, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(7, 7, 1, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(8, 5, 2, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59'),
(9, 7, 2, 'ACT', CURRENT_TIMESTAMP, '2099-12-31 23:59:59');
